...
#line 62 "symbol.y"
                               { printf("%f\n", (yyvsp[-1].dval)); }
#line 1187 "symbol.tab.c"
    break;

  case 4: /* lines: lines QUIT  */
#line 64 "symbol.y"
                            { exit(0); }
#line 1193 "symbol.tab.c"
    break;

  case 6: /* stmt: expr  */
#line 68 "symbol.y"
                      { (yyval.dval)=(yyvsp[0].dval); }
#line 1199 "symbol.tab.c"
    break;
...
#line 1207 "symbol.tab.c"
    break;

  case 8: /* expr: expr ADD expr  */
#line 74 "symbol.y"
                                { (yyval.dval)=(yyvsp[-2].dval)+(yyvsp[0].dval); }
#line 1213 "symbol.tab.c"
    break;

  case 9: /* expr: expr MINUS expr  */
#line 75 "symbol.y"
                                  { (yyval.dval)=(yyvsp[-2].dval)-(yyvsp[0].dval); }
#line 1219 "symbol.tab.c"
    break;

  case 10: /* expr: expr MUL expr  */
#line 76 "symbol.y"
                                { (yyval.dval)=(yyvsp[-2].dval)*(yyvsp[0].dval); }
#line 1225 "symbol.tab.c"
    break;

  case 11: /* expr: expr DIV expr  */
#line 77 "symbol.y"
                                { (yyval.dval)=(yyvsp[-2].dval)/(yyvsp[0].dval); }
#line 1231 "symbol.tab.c"
    break;

  case 12: /* expr: LPAREN expr RPAREN  */
#line 78 "symbol.y"
                                     { (yyval.dval)=(yyvsp[-1].dval); }
#line 1237 "symbol.tab.c"
    break;

  case 13: /* expr: MINUS expr  */
#line 79 "symbol.y"
                                          {(yyval.dval)=-(yyvsp[0].dval);}
#line 1243 "symbol.tab.c"
    break;

  case 14: /* expr: NUMBER  */
#line 80 "symbol.y"
                        {(yyval.dval)=(yyvsp[0].dval);}
#line 1249 "symbol.tab.c"
    break;
...
#line 1260 "symbol.tab.c"
    break;


#line 1264 "symbol.tab.c"
