...
main_gcc:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    ...
    11bf:	c7 45 f0 02 00 00 00 	movl   $0x2,-0x10(%rbp)
    11c6:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    11cd:	eb 0e                	jmp    11dd <main+0x54>
    11cf:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11d2:	0f af 45 f0          	imul   -0x10(%rbp),%eax
    11d6:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11d9:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    11dd:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11e0:	39 45 f0             	cmp    %eax,-0x10(%rbp)
    11e3:	7e ea                	jle    11cf <main+0x46>
    11e5:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11e8:	89 c6                	mov    %eax,%esi
    11ea:	48 8d 05 16 0e 00 00 	lea    0xe16(%rip),%rax        # 2007 <_IO_stdin_used+0x7>
    ...
    1207:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    120e:	00 00 
    1210:	74 05                	je     1217 <main+0x8e>
